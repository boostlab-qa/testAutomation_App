...
'STEP - 우리집 [수정] 버튼 선택'
Mobile.tap(findTestObject('07_adress_setting/btn_modify'), GlobalVariable.fixedTime)
...
'기대결과 - {주소 이름} 문구 미노출'
Mobile.verifyElementNotVisible(findTestObject('07_adress_setting/input_adress_detail_adress_name'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.verifyElementText(findTestObject('07_adress_setting/area_adress'), '경기 시흥시 배곧전원로 12-1 (배곧동) 우리집 상세주소', FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyElementText(findTestObject('06_mypage/ares_privacy_adress'), '경기 시흥시 배곧전원로 12-1 (배곧동) 우리집 상세주소 (15010)', FailureHandling.STOP_ON_FAILURE)
//

//마이페이지에서 주소 수정
'STEP - 주소 영역 선택'
Mobile.tap(findTestObject('06_mypage/ares_privacy_adress'), GlobalVariable.fixedTime)
...
Mobile.verifyElementText(findTestObject('04_home/area_adress_name'), GlobalVariable.adress_name, FailureHandling.STOP_ON_FAILURE)
//
...
Mobile.verifyElementText(findTestObject('04_home/area_adress_name'), '우리집', FailureHandling.STOP_ON_FAILURE)
//
...
if(Mobile.waitForElementNotPresent(findTestObject('07_adress_setting/btn_different_adress_name'), GlobalVariable.fixedTime, FailureHandling.STOP_ON_FAILURE))
{
...
Mobile.verifyElementText(findTestObject('04_home/area_adress_name'), 'TEST', FailureHandling.STOP_ON_FAILURE)
//
