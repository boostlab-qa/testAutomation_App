...
Mobile.verifyElementVisible(findTestObject('04_home/btn_home_adress_arrow'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)

'기대결과 - 홈 주소 찜한목록 [☆] 버튼 노출'
Mobile.verifyElementVisible(findTestObject('04_home/btn_home_favorite'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)

'기대결과 - 홈 주소 [QR] 버튼 노출'
Mobile.verifyElementVisible(findTestObject('04_home/btn_home_qr'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)
...
'기대결과 - 홈 검색 아이콘 노출'
Mobile.verifyElementVisible(findTestObject('04_home/icon_home_search'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)

'기대결과 - 홈 검색 플레이스홀더 문구 노출'
Mobile.verifyElementVisible(findTestObject('04_home/txt_home_search_title'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.verifyElementVisible(findTestObject('04_home/txt_home_login_title'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)

'기대결과 - 홈 로그인 유도 영역 안내문구 노출'
Mobile.verifyElementVisible(findTestObject('04_home/txt_home_login_guide'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)

'기대결과 - 홈 로그인 유도 영역 [시작하기] 버튼 노출'
Mobile.verifyElementVisible(findTestObject('04_home/btn_home_login'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)
...
if (Mobile.waitForElementNotPresent(findTestObject('04_home/02_contents/txt_find_hospital'), GlobalVariable.fixedTime))
	{
		'STEP - 화면 스크롤 이동'
...
Mobile.verifyElementVisible(findTestObject('04_home/02_contents/txt_find_hospital'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.verifyElementVisible(findTestObject('04_home/02_contents/area_find_hospital_icon'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.verifyElementNotVisible(findTestObject('04_home/txt_home_recommend_title'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)

'기대결과 - 홈 병원 추천(a) 병원 리스트 영역 미노출'
Mobile.verifyElementNotVisible(findTestObject('04_home/area_home_recommend_hospital'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)

'STEP - 홈 내 주변 약국 찾기 영역 미노출 상태면 스크롤 이동'
if (Mobile.waitForElementNotPresent(findTestObject('04_home/txt_home_find_pharmacy'), GlobalVariable.fixedTime))
	{
		'STEP - 화면 스크롤 이동'
...
Mobile.verifyElementVisible(findTestObject('04_home/txt_home_find_pharmacy'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)

'기대결과 - 홈 내 주변 약국 찾기 안내문구 노출'
Mobile.verifyElementVisible(findTestObject('04_home/txt_home_find_pharmacy_guide'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)

'STEP - 최상단 스크롤 이동'
Mobile.scrollToText('질병, 진료과, 병원을 검색해보세요.')

//'기대결과 - 홈 하단 배너 영역 노출'
//Mobile.verifyElementVisible(findTestObject('04_home/area_home_lower_banner'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)
