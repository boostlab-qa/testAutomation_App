...
Mobile.verifyElementVisible(findTestObject('05_home/txt_home_login_title'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)

'기대결과 - 홈 로그인 유도 영역 안내문구 노출'
Mobile.verifyElementVisible(findTestObject('05_home/txt_home_login_guide'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)

'기대결과 - 홈 로그인 유도 영역 [시작하기] 버튼 노출'
Mobile.verifyElementVisible(findTestObject('05_home/btn_home_login'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.verifyElementNotVisible(findTestObject('05_home/txt_home_recommend_title'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)

'기대결과 - 홈 병원 추천(a) 병원 리스트 영역 미노출'
Mobile.verifyElementNotVisible(findTestObject('05_home/area_home_recommend_hospital'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)
