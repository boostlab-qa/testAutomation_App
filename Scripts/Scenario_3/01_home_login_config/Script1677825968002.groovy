...
if(Mobile.waitForElementPresent(findTestObject('04_home/area_login'), GlobalVariable.fixedTime))
{
...
if (Mobile.waitForElementNotPresent(findTestObject('04_home/area_recommend_hospital'), GlobalVariable.fixedTime))
	{
		'STEP - 화면 스크롤 이동'
...
Mobile.verifyElementVisible(findTestObject('04_home/txt_recommend_title'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)

'기대결과 - 홈 병원 추천(a) 병원 리스트 영역 노출'
Mobile.verifyElementVisible(findTestObject('04_home/area_recommend_hospital'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)
